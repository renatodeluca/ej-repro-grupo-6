...
Para la realización del primer reporte de reproducibilidad en el márgen del curso electivo de Ciencia Social Abierta, se selecciona el trabajo de @palma_desafiando_2025, titulado "Desafiando la segregación de género en el mercado laboral: Factores que inciden en las inserciones laborales atípicas en términos de género en Chile". - Breve resumen del artículo seleccionado
...
Se seleccionó para la reproducción la **Figura 2**  de @palma_desafiando_2025, la cual corresponden a un gráfico de la segregación género en el mercado laboral 
![Figura 2. Porcentaje de personas ocupadas por rama de actividad económica y sexo](input/images/fig_2_palma_et_al_2025_original.png)


Además se seleccionó la **Figura 5** de @palma_desafiando_2025, gráfico de personas de 15 años y más ocupadas en empleos atípicos según sexo y número de hijos menores de cinco años, respectivamente.
![Figura 5. Personas de 15 años y más ocupadas en empleos atípicos según sexo y número de hijos menores de 5 años](input/images/fig_5_palma_etal_2025.png)
