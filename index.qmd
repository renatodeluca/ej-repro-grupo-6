...
proc_casen22 <- select(casen_2022, id_vivienda, sexo, n_ocupados, s5, nucleo_ajustado, pco2, pco2_b, activ, folio, nucleo)
```

- Incluye el código utilizado para procesar los datos, junto con una explicación de cada paso. 

- Los datos originales deben ser llamados desde input/data/original, el código de procesamiento se debe incluir en este mismo
 archivo (reporte-repro.qmd).
